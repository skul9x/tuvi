...
class GeminiClient:
    ...
    def construct_prompt(self, data):
        ...
        # Build prompt
        # Determine Style
        style = data['info'].get('reading_style', 'Nghiêm túc')
        
        STYLE_PROMPTS = {
            "Nghiêm túc": "Phong cách luận giải: NGHIÊM TÚC, CỔ ĐIỂN, SÂU SẮC. Dùng từ ngữ chuyên môn nhưng giải thích dễ hiểu.\nXưng hô: 'Tại hạ' hoặc 'Tôi', gọi người xem là 'Đương số'.",
            "Đời thường": "Phong cách luận giải: ĐỜI THƯỜNG, DÂN DÃ, DỄ HIỂU. Dùng ví dụ thực tế, tránh lạm dụng từ Hán Việt.\nXưng hô: 'Tôi', gọi người xem là 'Bạn'.",
            "Hài hước": "Phong cách luận giải: HÀI HƯỚC, TRẺ TRUNG, GEN Z. Dùng slang, teende, emoji vui nhộn.\nXưng hô: 'Ad' hoặc 'Tui', gọi người xem là 'Bồ' hoặc 'Đằng ấy'.",
            "Kiếm hiệp": "Phong cách luận giải: KIẾM HIỆP, CỔ TRANG. Dùng văn phong như trong phim chưởng, tiểu thuyết Kim Dung.\nXưng hô: 'Bần đạo' hoặc 'Lão phu', gọi người xem là 'Thí chủ' hoặc 'Huynh đài'.",
            "Chữa lành": "Phong cách luận giải: NHẸ NHÀNG, CHỮA LÀNH (HEALING). Tập trung vào khía cạnh tâm lý, khích lệ tinh thần.\nXưng hô: 'Mình', gọi người xem là 'Bạn'."
        }
        
        selected_style_prompt = STYLE_PROMPTS.get(style, STYLE_PROMPTS["Nghiêm túc"])
        ...
        - Ngày sinh (Dương lịch): {info['solar_date']} lúc {info['time']}
        - Ngày sinh (Âm lịch): {info['lunar_date']} ({info['can_chi']})
        - Cục: {info['cuc']}
        - Mệnh đóng tại: {info['menh_tai']}
        - Thân đóng tại: {info['than_tai']}
        - Năm xem hạn: {info['viewing_year']}
